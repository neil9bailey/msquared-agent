...
def generate_draft(content_type: str, input_text: str = "", context: dict = None) -> dict:
    ...
    item = {
        ...
        "context": context,
        "source": source,
        "source_intake_id": source.get("canonical_id") or source.get("id", ""),
        "external_source_id": source.get("source_id", ""),
        "action_type": content_type,
        "knowledge_used": context.get("knowledge_results", []),
        "similar_examples_used": context.get("similar_examples", []),
